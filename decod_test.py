...
#hex_data = ["A3", "0D", "1E", "28", "A9", "72", "7C", "54"]
hex_data = ["09","A3", "0D", "1E", "28", "A9", "72", "7C", "54"]
...
decoded_string = decode(hex_data)
...
debit = decode(["09", "A3", "0D", "1E", "28", "A9", "72", "7C", "54"])
print(f'{debit}\n')
debit2 = decode2(["06", "D4", "11", "92", "57", "F5"])
print(f'{debit2}\n')
